    ...
    void fullEndToEndTest() throws ExecutionException, InterruptedException {
        try {
            ...
            assertAll(
                    ...
                    () -> assertEquals(ReconciliationState.INCORRECT, firstTx.getReconciliationState())
            );
            ...
            assertAll(
                    ...
                    () -> assertEquals(ReconciliationState.CORRECT, secondTx.getReconciliationState())
            );
            ...
            assertAll(
                    ...
                    () -> assertEquals(ReconciliationState.INCORRECT, thirdTx.getReconciliationState())
            );
            ...
            assertAll(
                    ...
                    () -> assertEquals(ReconciliationState.CORRECT, fourthTx.getReconciliationState())
            );
            ...
            assertAll(
                    ...
                    () -> assertEquals(ReconciliationState.NOT_FOUND, fifthTx.getReconciliationState())
            );
